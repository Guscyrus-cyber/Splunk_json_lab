...
Please refer to Images # 1 and 2 for the corresponding command/query and output.
...
Please refer to Image 3 for the corresponding command/query and output.
...
Please refer to Image 4 for the corresponding command/query and output.
...
Please refer to Image 5 for the corresponding command/query and output.
...
Please refer to Image 6 for the corresponding command/query and output.
...
Please refer to Image 7 for the corresponding command/query and output.

Search: source="failed_logins.json" host="MacBookPro" index="auth" sourcetype="\_json"

Please refer to Images # 8 and 9 for the corresponding command/query and output.


search: index=auth sourcetype="\_json"\

Please refer to Images # 10 and 11 for the corresponding command/query and output.

Search: index=auth sourcetype="\_json" status=failed \| stats count by user, src_ip\

Please refer to Image 12 for the corresponding command/query and output.
...
Please refer to Image 13 for the corresponding command/query and output.
...
Please refer to Image 14 for the corresponding command/query and output.
...
Please refer to Image 15 for the corresponding command/query and output.
...
Please refer to Image 16 for the corresponding command/query and output.
...
Please refer to Image 17 for the corresponding command/query and output.
...
Please refer to Image 18 for the corresponding command/query and output.
...
Please refer to Image 19 for the corresponding command/query and output.
...
Please refer to Image 20 for the corresponding command/query and output.
...
Please refer to Image 21 for the corresponding command/query and output.
...
Please refer to Image 22 for the corresponding command/query and output.
...
Please refer to Image 23 for the corresponding command/query and output.
